# Generated by Django 2.0.2 on 2018-06-27 10:30
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('admin_level', models.CharField(choices=[('unit-admin', 'Unit Level Administrator'), ('branch-admin', 'Branch Level administrator'), ('dept-admin', 'Department Level Administrator'), ('select', 'Select Administrator Level')], default='select', max_length=30)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='branch_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orims.Branch'),
        ),
        migrations.AddField(
            model_name='administrator',
            name='staff_id',
