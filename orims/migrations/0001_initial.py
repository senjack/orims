# Generated by Django 2.0.2 on 2018-06-20 10:56
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('appointment_mode', models.CharField(choices=[('pend', 'Pending'), ('canc', 'Canceled'), ('setd', 'Settled'), ('slct', 'Select Appointment Mode')], default='select', max_length=15)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_address', models.CharField(blank=True, max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('admin_level', models.CharField(choices=[('unit-admin', 'Main System administrator'), ('branch-admin', 'Branch system administrator'), ('select', 'Select administrator level')], default='select', max_length=30)),
                ('branch_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orims.branch')),
